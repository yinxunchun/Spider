...
public class CQGOV implements GOV{
	...
	public void getCQGOVNews(){
		...
		String[] newsTitleLabel = new String[]{"id","title"};     //新闻标题标签 
		String[] newsContentLabel = new String[]{"class" ,"in_topicfont center"};  //新闻内容标签 "id","endText"
		String[] newsTimeLabel = new String[]{"class","topic_where center"};   //新闻时间"class","ep-time-soure cDGray"  
		String[] newsSourceLabel =new String[]{"class","topic_where center","重庆人民政府门户网站"}; //（3个参数）新闻来源 同新闻时间"class","ep-time-soure cDGray" 再加上一个"网易新闻-国内新闻"
...
//		System.out.println(date);
		...
		// 内容link 正则http://www.cq.gov.cn/zwgk/zfxx/2015/1/7/1351369.shtml
