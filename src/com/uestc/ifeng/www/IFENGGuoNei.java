...
/*
 * 简介：凤凰网的大陆新闻即为国内新闻
 * 该新闻是从20100101开始 一直到现在，2010年前的新闻已经找不到了
 * 新闻的主题链接如：http://news.ifeng.com/mainland/rt-channel/rtlist_20101231/1.shtml
 * 该程序获取从20100101开始一直到现在的新闻
 * 并具有每日更新新闻的程序（即更新当日的新闻）
 * 
 * */
public class IFENGGuoNei implements IFENG{
	...
	public void getIFENGGuoNeiNews(){
		...
		String[] newsSourceLabel =new String[]{"class","p_time","凤凰新闻-国内新闻"}; //（3个参数）新闻来源 同新闻时间
