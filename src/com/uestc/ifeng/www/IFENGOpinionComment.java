...
public class IFENGOpinionComment implements IFENGCOMMENT{
	...
	public void getIFENGOpinionComment(){
		System.out.println("opinioncomment start...");
		DBName = "IFENGCOMMENT";
		DBTable = "OPINION";
		ENCODE = "utf-8";
...
//				System.out.println(commentUrl);
		...
		System.out.println("opinioncomment over...");
	}
	@Override
...
//        System.out.println(html);
	...
	public static void main(String[] args){
		IFENGOpinionComment test = new IFENGOpinionComment();
		test.getIFENGOpinionComment();
	}
}
