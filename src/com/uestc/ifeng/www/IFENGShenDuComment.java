...
public class IFENGShenDuComment implements IFENGCOMMENT{
	...
	public void getIFENGShenDuComment(){
		System.out.println("sdcomment start...");
		DBName = "IFENGCOMMENT";
		DBTable = "SD";
		ENCODE = "utf-8";
...
//				System.out.println(html);
		...
		crut.destory();
		System.out.println("sdcomment over...");
...
//        System.out.println(html);
	...
	public static void main(String[] args){
		IFENGShenDuComment test = new IFENGShenDuComment();
		test.getIFENGShenDuComment();
	}
}
