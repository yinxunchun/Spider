...
public class SOHUGuoNeiComment implements SOHUCOMMENT{
	...
	public void getSOHUGuoNeiComment(){
		System.out.println("sohuguonei start...");
		DBName = "SOHUCOMMENT";
		DBTable = "GN";
		ENCODE = "gb2312";
...
//        System.out.println(html);
	...
	public static void main(String[] args){
		SOHUGuoNeiComment test = new SOHUGuoNeiComment();
		test.getSOHUGuoNeiComment();
	}
